        ...
        <div className="md:col-span-8 z-20 text-center md:text-left">
          ...
          <div className="mb-8">
            <h1 className="reveal-item text-[40px] md:text-[72px] font-black text-on-surface leading-[1.1] tracking-tighter">
              I am Nahid, <br className="md:hidden" />
          ...
          <p className="reveal-item text-[18px] md:text-[20px] text-on-surface-variant mb-12 max-w-lg leading-relaxed">
            Crafting premium web experiences with clean code and pixel-perfect design.
          </p>

          <div className="reveal-item flex flex-wrap gap-4 justify-center md:justify-start">
            {["React Expert", "UI / UX", "Clean Code"].map((tag) => (
